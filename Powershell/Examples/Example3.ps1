########EXAMPLE 3###################
# This is slightly different but very close to what the instructions ask you to do
# You should be able to figure out anything by looking at this.

#Parameters
#The script should take 3 arguments $source, $destination (for the source and destination folders) and the create flag
param([string]$source="c:\temp\source",[string]$destination="c:\temp\destination",[switch]$create)
